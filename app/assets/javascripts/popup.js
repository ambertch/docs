...
window.addEventListener('load', function webViewerLoad(evt) {
  ...
  console.log("TOOK SOME SHIT OUT HERE")
  ...
  document.getElementById('sidebarToggle').addEventListener('click',
    ...
    setTimeout(function(){
      PDFJS.workerSrc = '/worker_loader.js'; // AH: This is wrong - should just point to pdf.js
      
      PDFView.open('/cacdce-371468.pdf', 0);
      // PDFView.open('/azdce-54425.pdf', 0);
      // PDFView.open('https://s3.amazonaws.com/ambert-pdfs/UnderstandingTypes.pdf', 0)  
    }, 0);

  // PDFView.open(file, 0);
  
    console.log("OPEN CODE IS ON line 1382")
}, true);
